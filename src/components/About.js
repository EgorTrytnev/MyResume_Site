      ...
      <div className="container">
        ...
        <div className="about-content">
          ...
          >
            ...
            В настоящее время:
            <ul>
            <li>Активно участвую в хакатонах, развивая навыки командной работы и решения нестандартных задач.</li>
            <li>Участвовал в разработке небольшой игры с использованием GigaChat на Unity.</li>
            <li>Занимаюсь созданием собственной игры с перспективой публикации на игровых площадках.</li>
            <li>Прохожу обучение в Школе 21.</li>
            <li>Совершенствую C++ под руководством ментора из Arqa Technologies, изучая современные подходы и лучшие практики индустрии.</li>
            </ul>
            </p>
          </motion.div>
